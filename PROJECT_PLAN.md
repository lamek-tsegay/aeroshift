...
**How to use this file:** Paste this entire document into the first message of every new Claude / Claude Code session about Aero. Save it as `PROJECT_PLAN.md` and also as `PROJECT_NOTES.md` at the project root so Claude Code auto-reads it. Update section 10 at the end of every session.
...
6. **Close:** Ask Claude to update section 10 below.
...
**Update this section at the end of every session.** Ask Claude: "Update section 10 of PROJECT_NOTES.md to reflect what we accomplished and what's next."

**Last session:** \[date\] **Milestone:** \[number and name\] **Completed this session:** \[bullet list\] **Tests passing:** \[yes/no\] **Open questions / blockers:** \[bullet list\] **Next session goal:** \[single concrete sentence\]

---

## 11\. Useful mid-session prompts
...
## 12\. Phase 2 (only if you decide to grow this)
...
*End of context document. Append session updates above this line in section 10\.*  
